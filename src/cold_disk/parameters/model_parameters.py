...
class ModelParams:
    ...
    alpha_viscosity: np.ndarray = field(default_factory=lambda: np.array([0.1]))
    dimless_accrate: np.ndarray = field(default_factory=lambda: np.array([0.1, 1, 10]))
    dimless_bhmass: np.ndarray = field(default_factory=lambda: np.array([1e6, 1e7]))
    gas_index: np.ndarray = field(default_factory=lambda: np.array([3.0]))
    wind_index: np.ndarray = field(default_factory=lambda: np.array([0.0]))
    dimless_radius_in: np.ndarray = field(default_factory=lambda: np.array([1.0]))
    dimless_radius_out: np.ndarray = field(default_factory=lambda: np.array([10000.0]))
